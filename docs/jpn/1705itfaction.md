...
軍団長は1つの勢力に最大6名まで任命されます。
軍団長は毎週水曜日0時(UTC)に以下の条件を満たすユーザーが任命されます。

- 週間貢献度を2,500以上獲得したユーザーのうち、累積貢献度が高いユーザー

軍団長は戦場追放、戦場通知、防御艦隊強化の提案等を行う事ができる権限を持ちます。

- 累積貢献度 : 所属している勢力で獲得した貢献度の累積値
- 週間貢献度 : 所属している勢力で1週間獲得した貢献度 (毎週水曜日0時(UTC)基準)
...
軍団長は味方勢力が占領したセクターの保護状態を解除できます。

### 攻撃命令実行

軍団長は敵勢力のセクターに攻撃命令を出すことができます。

攻撃命令はキャピタルでのみ出せます。
攻撃命令は味方勢力が占領したセクターと隣接し、敵が占領した状態のセクターに出せます。<br>
攻撃命令を出すと侵攻待機状態になります。

攻撃命令が出されたセクターは味方勢力員の参加が可能になります。
