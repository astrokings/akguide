...
争奪戦は4週間に一度、UTC基準土曜日の午前00:00に開始し最大1日間、行われます。<br>
...
各チャージ段階ごとに、その次の段階に進むために必要なエネルギーポイントと所要時間は次の通りです。
 - 1段階 : 30 ポイント(所要時間 : 30分, 累積所要時間 : 30分)
 - 2段階 : 60 ポイント(所要時間 : 1時間, 累積所要時間 : 1時間 30分)
 - 3段階 : 90 ポイント(所要時間 : 1時間 30分, 累積所要時間 : 3時間)
 - 4段階 : 120 ポイント(所要時間 : 2時間, 累積所要時間 : 5時間)
 - 5段階 : 150 ポイント(所要時間 : 2時間 30分, 累積所要時間 : 7時間 30分)<br>
