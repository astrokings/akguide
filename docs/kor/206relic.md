...
블랙스톤 이외에도 크리스탈을 사용하여 각인을 진행할 수 있지만, 크리스탈을 사용할 경우에는 각 렐릭 회로 당 일일 10회의 제한이 있습니다.
...
| 이름 | 능력치 종류 |
| - | - |
| 출력 증폭 | 공격력<br>공격력<br>공격력 |
| 양자 가속 | 공격력<br>관통력<br>연사력 |
| 입자 가속 | 공격력<br>정확도<br>연사력 |
| 중성자 증폭 | 공격력<br>연사력<br>공격력 |
| 양자 증폭 | 공격력<br>관통력<br>사거리 |
| 이온 증폭 | 공격력<br>정확도<br>사거리 |
| 피해 제어 | 내구력<br>내구력<br>내구력 |
| 입자 방어 | 내구력<br>모든 저항력<br>캐논 저항력 |
| 질량 방어 | 내구력<br>모든 저항력<br>미사일 저항력 |
| 내열 방어 | 내구력<br>모든 저항력<br>빔 저항력 |
| 탄자 방어 | 내구력<br>모든 저항력<br>레일건 저항력 |
| 예측 기동 | 내구력<br>모든 회피력<br>캐논 회피력 |
| 미사일 교란 | 내구력<br>모든 회피력<br>미사일 회피력 |
| 열감지 센서 | 내구력<br>모든 회피력<br>빔 회피력 |
| 근접 회피 | 내구력<br>모든 회피력<br>레일건 회피력 |